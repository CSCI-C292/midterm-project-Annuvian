...
public class GameController : MonoBehaviour
{
    ...
    public void Win()
    {
        endGameMessage.text = "Mission completed. Congratulations, you have destroyed all your targets. Demo completed. Thank you for playing.";
        DisplayEndScreen();
    }
    ...
    {
        endGameMessage.text = "Mission failed. You have left the area of operations. Make sure not to fly to far away from the area of the targets at the base of the cliff directly ahead of you at the mission start!";
        DisplayEndScreen();
    }
